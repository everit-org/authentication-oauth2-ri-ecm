...
public class OAuth2SessionAttributeNamesComponent implements OAuth2SessionAttributeNames {
  ...
  @StringAttribute(
      attributeId = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_ACCESS_TOKEN,
      defaultValue = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_ACCESS_TOKEN)
  ...
  @StringAttribute(
      attributeId = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_ACCESS_TOKEN_TYPE,
      defaultValue = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_ACCESS_TOKEN_TYPE)
  ...
  @StringAttribute(
      attributeId = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_EXPIRES_IN,
      defaultValue = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_EXPIRES_IN)
  ...
  @StringAttribute(
      attributeId = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_REFRESH_TOKEN,
      defaultValue = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_REFRESH_TOKEN)
  ...
  @StringAttribute(attributeId = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_SCOPE,
      defaultValue = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_SCOPE)
  public void setSessionAttrNameScope(final String sessionAttrNameScope) {
    this.sessionAttrNameScope = sessionAttrNameScope;
  }

  @StringAttribute(
      attributeId = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_PROVIDER_NAME,
      defaultValue = OAuth2SessionAttributeNamesConstants.SESSION_ATTR_NAME_PROVIDER_NAME)
